def send_email(message, recipient,* , sender = "university.help@gmail.com"):
  ...
  if not('@' in sender and any(sender.endswith(domain) for domain in valid_domians))\
  and ('@' in recipient and any(recipient.endswith(domain) for domain in valid_domians)):
